...
export default function LoginPage() {
  ...
  return (
    <div className="flex-1 flex flex-col justify-center items-center px-4 relative bg-radial from-slate-900 via-slate-950 to-black overflow-hidden select-none">
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary/10 rounded-full blur-3xl -z-10 animate-pulse duration-6000"></div>
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-500/5 rounded-full blur-3xl -z-10 animate-pulse duration-8000"></div>
      ...
      <Card className="w-full max-w-md border-slate-800 bg-slate-950/40 backdrop-blur-xl shadow-2xl text-slate-100">
              ...
              <FieldContent>
                <div className="relative">
                  ...
                  <Button
                    ...
                    variant="ghost"
                    size="icon-sm"
                    className="absolute right-2 top-1.5 cursor-pointer z-10 text-slate-500 hover:text-slate-300 hover:bg-slate-800/50"
        ...
        <CardFooter className="flex flex-col gap-2 pb-6 border-t border-slate-900/60 mt-4 text-center text-xs">
          <p className="text-slate-400">
            ...
            <Link
              href="/register"
              className="text-white hover:text-blue-400 font-medium underline underline-offset-4 hover:underline transition-colors"
            >
              Sign up
            </Link>
          </p>
